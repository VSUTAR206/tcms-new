...
const AdminDashboard = () => {
  ...
  return (<>
    ...
    <div className="container overflow-auto">
      ...
      <div className="row">
        <div className="col-6 ">
          <h3 className="text-center">AdminDashboard menu</h3>
          <div className="row    row-cols-1 row-cols-sm-1  row-cols-md-2  row-cols-lg-3 g-3 " style={{ justifyContent: "center" }}>
            ...
            <div className="col">
              <div className="card">
                <img src="./img/syllabus1.jpeg" className="card-img-top" alt="card-grid-image" />
                <div className="card-body">
                  <h5 className="card-title">Fees & collections</h5>
                </div>
              </div>
            </div>
            ...
            <div className="col">
              <div className="card">
                <img src="./img/syllabus1.jpeg" className="card-img-top" alt="card-grid-image" />
                <div className="card-body">
                  <h5 className="card-title">Exmas</h5>
                </div>
              </div>
            </div>
            ...
            <div className="col">
              <div className="card">
                <img src="./img/syllabus1.jpeg" className="card-img-top" alt="card-grid-image" />
                <div className="card-body">
                  <h5 className="card-title">Staff Managements</h5>
                </div>
              </div>
            </div>
